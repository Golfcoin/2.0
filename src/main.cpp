...
unsigned int nStakeMaxAge = 7 * 24 * nOneHour; // 7 days as full weight
...
const string strMessageMagic = "GolfCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("GolfCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GolfCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // GolfCoin: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfStake() && nHeight < FIRST_POS_BLOCK)
        return DoS(100, error("AcceptBlock() : reject proof-of-stale at height %d", nHeight));
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GolfCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "GOLF Genesis";
        CTransaction txNew;
        txNew.nTime = 1472397433;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1472397437;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3552848; // !fTestNet ? 1575379 : 46534;
	
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7767a98ddca8973f0434ee77f932b58cca5d762d143a0e169732ffa2f028abff"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xfb, 0xe1, 0xea };
